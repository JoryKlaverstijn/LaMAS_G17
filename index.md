...
The graphical user interface (GUI) consists of the players, each with their roles revealed, a reset button a next step button, a console to view the game progression and buttons numbering from 1 to the amount of players. View [this figure](#fig-gui) for an overview.

{% figure caption:"Title: Graphical User Interface of the Game" %}
<img id="fig-gui" src="https://user-images.githubusercontent.com/63637256/175936223-09cc176f-87d9-4b66-8eaf-3a8cc9137b7d.png" />
{% endfigure %}
